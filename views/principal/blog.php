...
?>
<section class='blog' id='blog' style='padding-top:100px;background:whitesmoke;padding-bottom:50px;'>
    
    <div><h1 class='text-center' style="font-family:'Montserrat Alternates'">Blog<div class="mx-auto mt-2" style="width:100px;border-bottom: solid 5px #8e3a20"></div></h1></div>
<!--    <div class='text-center mx-auto' style="width:50%;min-width:300px;font-family:'Montserrat Alternates';font-size:20px; font-weight:900;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s. -->
    </div>
     <div class='blog_container mx-auto slider-blog owl-carousel owl-theme' style=''>
           <?php 
               //Connection
